...
# --- Importación para timeline visual itinerario ---
...
observaciones_demo = [
    # Semana 1 – Inicio con dificultades generales
    {"semana": 1, "dimension": "Desempeño técnico", "indicador": "Precisión técnica", "evaluacion": "❌ Crítico",
     "observacion": "Errores frecuentes al clasificar los pedidos. Se confunden referencias similares."},
    {"semana": 1, "dimension": "Estabilidad emocional", "indicador": "Estado emocional", "evaluacion": "⚠️ Cuidado",
     "observacion": "Mostró nerviosismo al trabajar bajo presión. Necesita refuerzos constantes."},
    {"semana": 1, "dimension": "Nivel de apoyos requeridos", "indicador": "Uso de apoyos previstos", "evaluacion": "❌ Crítico",
     "observacion": "Solicitó ayuda en tareas básicas, por encima del nivel previsto en el plan inicial."},

    # Semana 2 – Persisten dificultades técnicas y emocionales
    {"semana": 2, "dimension": "Desempeño técnico", "indicador": "Tiempo de ejecución", "evaluacion": "⚠️ Cuidado",
     "observacion": "Lento al empaquetar. No logra mantener ritmo estándar, pero mejora leve respecto semana anterior."},
    {"semana": 2, "dimension": "Interacción social y adaptación", "indicador": "Aislamiento", "evaluacion": "⚠️ Cuidado",
     "observacion": "Evita participar en las pausas grupales. Se muestra retraído con compañeros."},
    {"semana": 2, "dimension": "Riesgo de ruptura", "indicador": "Comentarios de abandono", "evaluacion": "✔️ Bien",
     "observacion": "No expresó desmotivación, aunque verbalizó que el trabajo es 'muy exigente'."},

    # Semana 3 – Primeros avances en estabilidad y autonomía
    {"semana": 3, "dimension": "Estabilidad emocional", "indicador": "Motivación", "evaluacion": "✔️ Bien",
     "observacion": "Actitud positiva tras completar tareas con éxito. Se muestra más confiado."},
    {"semana": 3, "dimension": "Nivel de apoyos requeridos", "indicador": "Solicitud de ayuda no planificada", "evaluacion": "⚠️ Cuidado",
     "observacion": "Pide aclaraciones no previstas, pero menos frecuentes que semanas anteriores."},
    {"semana": 3, "dimension": "Interacción social y adaptación", "indicador": "Interacción social", "evaluacion": "⚠️ Cuidado",
     "observacion": "Participa en conversaciones breves. Muestra intención de integrarse."},

    # Semana 4 – Estancamiento leve, dificultad ante cambio menor
    {"semana": 4, "dimension": "Desempeño técnico", "indicador": "Adaptación a cambios menores", "evaluacion": "❌ Crítico",
     "observacion": "Se introdujo nuevo protocolo de empaquetado. Mostró resistencia y cometió errores."},
    {"semana": 4, "dimension": "Estabilidad emocional", "indicador": "Estado emocional", "evaluacion": "⚠️ Cuidado",
     "observacion": "Más irritable al final de jornada. Requiere pausas más frecuentes."},
    {"semana": 4, "dimension": "Riesgo de ruptura", "indicador": "Absentismo", "evaluacion": "✔️ Bien",
     "observacion": "Asistencia completa y puntual durante toda la semana."},

    # Semana 5 – Avance técnico y emocional sólido
    {"semana": 5, "dimension": "Desempeño técnico", "indicador": "Precisión técnica", "evaluacion": "✔️ Bien",
     "observacion": "Cumplió los estándares de calidad en el 85% de los pedidos sin supervisión."},
    {"semana": 5, "dimension": "Interacción social y adaptación", "indicador": "Interacción social", "evaluacion": "✔️ Bien",
     "observacion": "Interactuó espontáneamente con compañeros. Respondió con humor a correcciones."},
    {"semana": 5, "dimension": "Nivel de apoyos requeridos", "indicador": "Uso de apoyos previstos", "evaluacion": "✔️ Bien",
     "observacion": "Utilizó los apoyos según lo planificado, sin dependencia adicional."},

    # Semana 6 – Retroceso puntual en motivación, pero sin impacto general
    {"semana": 6, "dimension": "Estabilidad emocional", "indicador": "Motivación", "evaluacion": "⚠️ Cuidado",
     "observacion": "Menor entusiasmo general. Comentó estar 'cansado de lo mismo'."},
    {"semana": 6, "dimension": "Desempeño técnico", "indicador": "Tiempo de ejecución", "evaluacion": "✔️ Bien",
     "observacion": "Cumple los tiempos estimados con consistencia. Supervisión mínima."},
    {"semana": 6, "dimension": "Riesgo de ruptura", "indicador": "Comentarios de abandono", "evaluacion": "✔️ Bien",
     "observacion": "Sin verbalizaciones negativas. Se mostró dispuesto a continuar."},

    # Semana 7 – Consolidación en desempeño y relaciones
    {"semana": 7, "dimension": "Desempeño técnico", "indicador": "Adaptación a cambios menores", "evaluacion": "✔️ Bien",
     "observacion": "Se adaptó sin problema a un nuevo lote de tareas."},
    {"semana": 7, "dimension": "Interacción social y adaptación", "indicador": "Aislamiento", "evaluacion": "✔️ Bien",
     "observacion": "Participa activamente en dinámicas grupales. Muy integrado."},
    {"semana": 7, "dimension": "Estabilidad emocional", "indicador": "Estado emocional", "evaluacion": "✔️ Bien",
     "observacion": "Ánimo estable durante la semana. Expresó satisfacción al final de jornada."},

    # Semana 8 – Nivel óptimo sostenido, apto para cierre
    {"semana": 8, "dimension": "Desempeño técnico", "indicador": "Precisión técnica", "evaluacion": "✔️ Bien",
     "observacion": "100% de los pedidos clasificados correctamente esta semana."},
    {"semana": 8, "dimension": "Nivel de apoyos requeridos", "indicador": "Solicitud de ayuda no planificada", "evaluacion": "✔️ Bien",
     "observacion": "No se registraron solicitudes fuera del plan. Trabajó con autonomía estable."},
    {"semana": 8, "dimension": "Estabilidad emocional", "indicador": "Motivación", "evaluacion": "✔️ Bien",
     "observacion": "Demostró entusiasmo, propuso mejoras en el sistema de clasificación."}
]

seguimiento_demo = {
    "nombre_persona": "Lucas Pérez",
    "rama": "CIL",
    "autonomia": 4,
    "resultado_fase_4": "Integración estable",
    "duracion_seguimiento": 8,
    "frecuencia_revision": "semanal",
    "observaciones": observaciones_demo
}

# Precarga el seguimiento si aún no está en sesión
if "seguimiento" not in st.session_state:
    st.session_state["seguimiento"] = seguimiento_demo
...
if opcion == "Perfil funcional":
    ...
    st.title("Módulo 1: Perfil funcional del candidato")
    st.markdown(
    ...
    # Agrupación de resultados en un diccionario
    perfil_funcional = {
        "edad": edad,
        "formacion": formacion,
    ...
    # BLOQUE 1: Validaciones de campos obligatorios no rellenados

    # Edad ya está limitada por el control numérico, pero se refuerza
    if edad is None or edad < 14:
        st.error("La edad debe ser igual o mayor a 14 años.")

    # Nivel educativo
    if formacion == "":
        st.warning("Por favor, selecciona el nivel educativo alcanzado.")

    # Experiencia previa sin descripción
    ...
    # BLOQUE 2: Relaciones incoherentes entre campos
    ...
    # BLOQUE 3: Valores extremos que requieren atención
    ...
    # BLOQUE 4: Confirmación general

    if st.button("Validar y continuar al Módulo 2"):
        st.session_state.perfil_funcional = perfil_funcional
        st.success("Perfil guardado correctamente. Puedes continuar al siguiente módulo.")
    ...
    if "ofertas_guardadas" not in st.session_state:
        st.session_state.ofertas_guardadas = [
            ...
            {
                "id": "E004",
                "nombre": "Preparador de pedidos",
                "departamento": "Almacén",
                "descripcion": "Recogida, clasificación y empaquetado de pedidos en entorno de almacén semiautomatizado. Requiere ritmo constante, comprensión de instrucciones básicas y buena precisión manual.",
                "autonomia_laboral": "Alta",
                "comprension": "Media",
                "atencion": 4,
                "motricidad": "Media",
                ...
                "iniciativa": "Media",
                "adaptabilidad": "Sí",
                "tareas": ["Almacén", "Montaje", "Verificación"]
            }
        ]
    ...
    if subopcion == "Añadir nueva oferta de trabajo":
        ...
        with st.form("form_nueva_oferta"):
            ...
            if enviado:
                ...
                # If editing, replace the existing offer
                if oferta_en_edicion:
    ...
    st.title("Módulo 2: Sistema de Matching")
    ...
    if perfil is None:
        ...
        def evaluar_compatibilidad(perfil, oferta):
            ...
            # Motricidad (motricidad fina y movilidad): Casuísticas parciales
            ...
            # Trabajo en equipo y habilidades sociales: Casuística parcial
            ...
            # Tolerancia al cambio (sin casuística adicional)
            ...
            # Formación: Añadir sobrecualificación explícita
            ...
            if f_diff == 0:
                ...
                # Sobre cualificación explícita si la diferencia es grande
            ...
            # Estilo de aprendizaje: Añadir explicación si el perfil es diverso
            ...
            if set(estilos_perfil).intersection(set(estilos_oferta)):
                ...
                detalle.append("❌ Estilo de aprendizaje")
                # Casuística: perfil con varios estilos, aunque no coincidan
            ...
            # Iniciativa: Añadir caso diferencia de un punto
            ...
            # Apoyos disponibles: Añadir caso de diferencia pequeña
        ...
        for oferta, resultado in resultados_ofertas:
            with st.expander(f"{oferta['id']} - {oferta['nombre']}                                                                 Puntuación: {resultado['puntos']}/15"):
                ...
                # --- BLOQUE VISUALIZACIÓN DE ATRIBUTO CLAVE ---
    ...
    # Lógica para mostrar el Módulo 3: Itinerario personalizado
    ...
    st.subheader("🧭 Módulo 3: Itinerario personalizado")
    # Aquí comienza el único bloque de generación y visualización del itinerario personalizado
    ...
    # --- RESUMEN GENERAL DE PERFIL Y PUESTO ---
    ...
    **Puesto seleccionado:**
    ...
    with st.expander("Fase 1: Preparación y preincorporación", expanded=True):
        ...
        **Objetivo general:** Organizar las acciones previas a la incorporación, centradas en la adaptación del entorno, sensibilización del equipo y apoyos iniciales para facilitar la integración de la persona candidata.
        ...
        # --- Visualización con visjs_component (línea de tiempo numérica por semanas) ---
        # Cálculo de duración y apoyos (obtenemos duracion_fase1 aquí para usarlo)
        ...
        # === BLOQUE AÑADIDO: Contenido completo de la Fase 1 antes del gráfico ===
        # Preparamos subfases y apoyos para el bloque textual
        ...
        # Justificación de la fase (puede personalizarse más)
        justificacion_fase1 = []
        ...
        # === PERSONALIZACIÓN ADICIONAL FASE 1 ===
        # Si aún no existe nivel_formacion, lo calculamos a partir de formacion textual
        ...
        # Caso: Formación baja + tareas no estandarizadas
        ...
        # Si aún no existe interaccion, lo calculamos a partir de trabajo_equipo
        ...
        # Caso: Interacción baja + atención al público
        ...
        # === FIN PERSONALIZACIÓN ADICIONAL FASE 1 ===

        # Bloque textual antes del gráfico
    ...
    def procesar_datos_observaciones(observaciones):
        ...
        for obs in observaciones:
            ...
            if not eval:
                continue  # Evitamos errores si hay una evaluación no reconocida
    ...
    # Gráfico de evolución semanal ✔️ ⚠️ ❌
    ...
    # PDF (solo si wkhtmltopdf está instalado y accesible)
    try:
